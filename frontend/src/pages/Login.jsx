      ...
      <div className="w-full max-w-[420px] relative z-10 animate-scaleIn">
        ...
        <div className="text-center mb-8">
          <div className="relative w-16 h-16 mx-auto mb-5">
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-brand-500 to-indigo-500 opacity-20 blur-xl" />
            <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-br from-brand-500 to-indigo-500 flex items-center justify-center shadow-glow-brand">
        ...
        <div className="glass-card rounded-2xl p-8">
          ...
          {/* Error */}
          {error && (
            <div className="mb-6 p-3.5 rounded-xl bg-red-500/[0.08] border border-red-500/20 text-red-300 text-xs flex items-start space-x-3 animate-fadeIn">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="animate-slideUp" style={{ animationDelay: '0.15s' }}>
              <button
                ...
                className="w-full mt-2 py-3 px-4 rounded-xl btn-primary text-white font-semibold text-sm flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
              >
                {isSubmitting ? (
                  <>
